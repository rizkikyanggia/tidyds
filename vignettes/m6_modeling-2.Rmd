...
`sherlock_tfidf` tersebut akan lebih mudah dicerna jika ditampilkan dalam bentuk grafik. Pada *chunk* berikut kita akan memvisualisasikan data tersebut dengan menampilkan 15 kata terpenting untuk sucerita "I. A SCANDAL IN BOHEMIA"
...
sherlock_tfidf %>% 
  ...
  labs(
    ...
    subtitle = "Subcerita 'A Scandal in Bohemia'"
  ) +
  theme_light()
```
