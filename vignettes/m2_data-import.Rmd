...
Terakhir lakukanlah perbandingan antara jenis data pada kolom `program` dari masing-masing dataset tersebut! Anda dapat mengekstrak kolom dari suatu *dataframe* menggunakan operator `$` dengan format `nama_obyek$nama_kolom`. Gunakanlah fungsi `class()` seperti di atas! (Petunjuk: `stringsAsFactors = TRUE`)
